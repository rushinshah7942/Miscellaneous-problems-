...
public class Solution 
{
    public int nthUglyNumber(int n) 
    {
        ...
        ArrayList<Integer> list = new ArrayList<Integer>(); // using ArrayList will increase time complexity
		// as list.add() has amortized O(n) solution
        list.add(1);
...
// faster then previous, as we are using array
